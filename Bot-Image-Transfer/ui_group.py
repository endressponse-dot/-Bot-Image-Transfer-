...
class BackToMainMenuButton(discord.ui.Button):
    def __init__(self, guild_id: int, locale, bot=None, row: int = 2):
...
class GroupChannelSelectView(discord.ui.View):
    def __init__(self, guild_id: int, group_name: str, action_type: str, locale, bot=None):
...
class OperationSelectView(discord.ui.View):
    def __init__(self, guild_id: int, locale, bot=None):
        super().__init__(timeout=180)
        self.guild_id = guild_id
        self.locale = locale
        self.bot = bot
